    ...
    */
    if (confirmed !== true) {
      return {
        ...
        message: 'Explicit confirmation is required before creating a support ticket.'
      };
    }
    ...
    tickets.push(ticket);
    await writeFile(this.ticketsFile, `${JSON.stringify(tickets, null, 2)}\n`);
    ...
    await appendFile(this.auditFile, `${JSON.stringify(auditEvent)}\n`);
