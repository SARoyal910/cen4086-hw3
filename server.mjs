...
const server = new McpServer(
  { name: 'gardenguru-support', version: '1.0.0' },
...
server.registerResource(
  ...
  'business://policies',
  {
    title: 'GardenGuru policy documents',
    description: 'Read-only GardenGuru source documents used to ground customer answers.',
  ...
  ({ customerMessage }) => ({
    messages: [{
      ...
      content: {
        type: 'text',
        text: [
          'Resolve this support request for GardenGuru:',
          customerMessage,
          '',
          'Workflow:',
